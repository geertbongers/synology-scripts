...
if [ -f "${DOWNLOADDIR}/${FILENAME}" -a "${FORCE}" != "yes" ]; then
	...
	cp /volume1/applications/synology-scripts/plex-pass-update/plex.info /volume1/applications/synology-scripts/plex-pass-update/plex-new.info
	echo 'version="${VERSION}"' >> /volume1/applications/synology-scripts/plex-pass-update/plex-new.info
	mv /volume1/applications/synology-scripts/plex-pass-update/plex-new.info /volume1/web/sspks/packages/plex_bromolow_${VERSION}.info
